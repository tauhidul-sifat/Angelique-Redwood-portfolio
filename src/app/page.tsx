...
const page = () => {
  ...
  lg:dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500"
    >
        ...
        <div className="grid sm:grid-cols-2 sm:items-center gap-8">
          ...
          <div className="sm:order-1">
            ...
            <div className="mt-8 gap-3 flex-col md:flex-row flex justify-start">
              <ButtonAnimation>
                <a
                  className="inline-flex w-full duration-300 justify-center items-center gap-x-3 text-center bg-gradient-to-tl from-rose-600 to-pink-600  focus:outline-none   border border-transparent text-white text-sm font-medium rounded-full py-3 px-4"
                  href="#"
                >
                  <svg
              ...
              <ButtonAnimation>
                <a
                  className="inline-flex w-full justify-center items-center gap-x-3 text-center bg-gradient-to-tl from-blue-600 to-violet-600  focus:outline-none   border border-transparent text-white text-sm font-medium rounded-full py-3 px-4"
                  href="#"
                >
                  <svg
                    className="shrink-0 size-4"
      ...
      {/* <!-- Card Grid --> */}
      <div className="grid grid-cols-1 gap-3 md:gap-1 lg:gap-0 my-8 lg:grid-cols-3 items-center">
        <h3>Featured</h3>
        {/* <!-- Card --> */}
        <a
